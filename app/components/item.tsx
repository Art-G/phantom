...
export const Item: FunctionComponent<ItemProps> = (itemProps) => {
  const {
    child: { name, manifest, script, nextLaunchIn },
    index,
  } = itemProps;
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          {nextLaunchIn ? <span className="text-xs mr-4">Next launch in <span className="text-green-600">{new Date(nextLaunchIn * 1000).toISOString().slice(14, 19)} s.</span></span> : null}
      ...
      <p className="text-gray-400 text-xs mb-2">{script}</p>
